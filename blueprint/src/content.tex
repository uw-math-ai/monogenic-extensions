...
\texttt{adjoin\_residue\_eq\_top\_of\_adjoin\_eq\_top} is a general local ring fact.
\texttt{finrank\_eq\_finrank\_residueField} requires étale hypotheses.

\textbf{Option A:} Put the first in
...
\textbf{Option B (simpler):} Both in a new file
...
\texttt{IsLocalRing} or \texttt{Algebra} namespace.
...
\begin{itemize}
  ...
  \item These lemmas may already exist in Mathlib under different names.
